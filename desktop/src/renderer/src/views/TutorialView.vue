  ...
  <section class="tutorial">
    ...
    <article class="doc app-scroll">
      ...
      <ol class="steps">
        ...
        <li>
          <b>开始备份</b>——点击开始后可随时暂停/恢复；完成后进入「档案列表」离线浏览。
        </li>
      </ol>
      <div class="tip">
      ...
      <ul>
        ...
        <li><b>访问空间</b>——输入任意 QQ 号（好友可从列表选择），备份其公开内容。选好后点「校验」确认对方空间可访问；非好友仅能备份公开内容。</li>
      </ul>
      <h3>第②步 · 选择内容</h3>
      <p>
      ...
      <ul>
        <li><b>离线浏览</b>——「档案列表」里点「浏览」，或直接双击备份目录中的 <code>index.html</code>；支持按年份归档、全文搜索、图片/视频画廊。</li>
